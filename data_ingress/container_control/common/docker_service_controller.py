...
from data_ingress.common.os_operations.command_executor import CommandExecutor
...
class DockerServiceController:
    def __init__(self, kafka_service_data: Dict, docker_compose_up_cmd: str, docker_compose_down_cmd: str):
        ...
        self.docker_compose_up_cmd: str = docker_compose_up_cmd
        self.docker_compose_down_cmd: str = docker_compose_down_cmd
    ...
    def docker_compose_up(self, request: HttpRequest) -> HttpResponse:
        ...
        try:
            self.command_executor.execute_command(self.docker_compose_up_cmd)
    ...
    def docker_compose_down(self, request: HttpRequest) -> HttpResponse:
        ...
        try:
            self.command_executor.execute_command(self.docker_compose_down_cmd)
        except Exception as e:
