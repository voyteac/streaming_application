...
def save_kafka_message_to_database(kafka_msg: ConsumerRecord) -> None:
    log_info(save_kafka_message_to_database, 'Loading message to database_handling')
...
def get_database_message_from_kafka_message(kafka_msg: ConsumerRecord) -> DataBaseLoader:
    log_debug(get_database_message_from_kafka_message,f'Kafka message to database_handling message conversion ...')
    try:
        ...
        log_debug(get_database_message_from_kafka_message, f'Kafka message to database_handling message conversion - Done! Database message\n{kafka_msg}')
